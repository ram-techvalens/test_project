...
?>
<h3 id="custom-fields"><?php _e( 'Field - ', 'wpas-cf' ); ?><span><?php _e( $title, 'wpas-cf' ); ?></span></h3>
...
<tbody class="wpas-cf-wrapper-object">
	...
	<!-- extra_wrapper_css_classes field -->
	<tr class="wpas-cf-extra-wrapper-css-classes">
		...
		<td class="second wpas-cf-input wpas-cf-extra-wrapper-css-classes-field">
			...
			<?php if( ! empty( $extra_wrapper_css_classes ) ) : ?>
				<input type="text" name="extra-wrapper-css-classes" placeholder="<?php _e( 'Extra CSS Class Name(s)', 'wpas-cf' ) ?>" value="<?php echo $extra_wrapper_css_classes ?>">
			<?php else : ?>
				<input type="text" name="extra-wrapper-css-classes" placeholder="<?php _e( 'Extra CSS Class Name(s)', 'wpas-cf' ) ?>">
			<?php endif; ?>
		</td>
	</tr>
	
	<!-- extra_field_css_classes field -->	
	<tr class="wpas-cf-extra-wrapper-css-classes">
		<th class="first">
		...
		<td class="second wpas-cf-input wpas-cf-extra-field-css-classes-field">
			...
			<?php if( ! empty( $extra_field_css_classes ) ) : ?>
				<input type="text" name="extra-field-css-classes" placeholder="<?php _e( 'Extra CSS Class Name(s)', 'wpas-cf' ) ?>" value="<?php echo $extra_field_css_classes ?>">
			<?php else : ?>
				<input type="text" name="extra-field-css-classes" placeholder="<?php _e( 'Extra CSS Class Name(s)', 'wpas-cf' ) ?>">
			<?php endif; ?>
		</td>
	</tr>

	<!-- extra_wrapper_css_classes-be field -->	
	<tr class="wpas-cf-extra-wrapper-css-classes-be">
		...
		<td class="second wpas-cf-input wpas-cf-extra-wrapper-css-classes-be-field">
			...
			<?php if( ! empty( $extra_wrapper_css_classes_be ) ) : ?>
				<input type="text" name="extra-wrapper-css-classes-be" placeholder="<?php _e( 'Extra CSS Class Name(s)', 'wpas-cf' ) ?>" value="<?php echo $extra_wrapper_css_classes_be ?>">
			<?php else : ?>
				<input type="text" name="extra-wrapper-css-classes-be" placeholder="<?php _e( 'Extra CSS Class Name(s)', 'wpas-cf' ) ?>">
			<?php endif; ?>
		</td>
	</tr>
	
	<!-- extra_field_css_classes-be field -->	
	<tr class="wpas-cf-extra-wrapper-css-classes-be">
		<th class="first">
		...
		<td class="second wpas-cf-input wpas-cf-extra-field-css-classes-be-field">
			...
			<?php if( ! empty( $extra_field_css_classes_be ) ) : ?>
				<input type="text" name="extra-field-css-classes-be" placeholder="<?php _e( 'Extra CSS Class Name(s)', 'wpas-cf' ) ?>" value="<?php echo $extra_field_css_classes_be ?>">
			<?php else : ?>
				<input type="text" name="extra-field-css-classes-be" placeholder="<?php _e( 'Extra CSS Class Name(s)', 'wpas-cf' ) ?>">
			<?php endif; ?>
		</td>
	</tr>
	...
	<tr class="wpas-cf-boot-strap-row-fe-start">
		...
		<td class="second wpas-cf-input wpas-cf-boot-strap-row-fe-start-field">
			...
			<select>
				<?php if( ! empty( $boot_strap_row_fe_start ) && $boot_strap_row_fe_start == true ) : ?>
					<option value="1" selected><?php _e( 'True', 'wpas-cf' ) ?></option>
					<option value="0"><?php _e( 'False', 'wpas-cf' ) ?></option>
				<?php else : ?>
					<option value="1"><?php _e( 'True', 'wpas-cf' ) ?></option>
	...
	<tr class="wpas-cf-boot-strap-row-fe-end">
		...
		<td class="second wpas-cf-input wpas-cf-boot-strap-row-fe-end-field">
			...
			<select>
				<?php if( ! empty( $boot_strap_row_fe_end ) && $boot_strap_row_fe_end == true ) : ?>
					<option value="1" selected><?php _e( 'True', 'wpas-cf' ) ?></option>
					<option value="0"><?php _e( 'False', 'wpas-cf' ) ?></option>
				<?php else : ?>
					<option value="1"><?php _e( 'True', 'wpas-cf' ) ?></option>
	...
	<tr class="wpas-cf-boot-strap-column-fe">
		...
		<td class="second wpas-cf-input wpas-cf-boot-strap-column-fe-field">
			<p class="description"><?php _e( 'Place field in a separate column?', 'wpas-cf' ) ?></p>
			<select>
				<?php if( ! empty( $boot_strap_column_fe ) && $boot_strap_column_fe == true ) : ?>
					<option value="1" selected><?php _e( 'True', 'wpas-cf' ) ?></option>
					<option value="0"><?php _e( 'False', 'wpas-cf' ) ?></option>
				<?php else : ?>
					<option value="1"><?php _e( 'True', 'wpas-cf' ) ?></option>
	...
	<tr class="wpas-cf-save-callback">
		...
		<td class="second wpas-cf-input wpas-cf-save-callback-field">
			...
			<?php if( ! empty( $save_callback ) ) : ?>
				<input type="text" name="save-callback" placeholder="<?php _e( 'Callback Function Name', 'wpas-cf' ) ?>" value="<?php echo $save_callback ?>">
			<?php else : ?>
				<input type="text" name="save-callback" placeholder="<?php _e( 'Callback Function Name', 'wpas-cf' ) ?>">
			<?php endif; ?>
		</td>
	</tr>
	...
	<tr class="wpas-cf-column-callback">
		...
		<td class="second wpas-cf-input wpas-cf-column-callback-field">
			<p class="description"><?php _e( 'Callback function when displaying column', 'wpas-cf' ) ?></p>
			<?php if( ! empty( $column_callback ) ) : ?>
				<input type="text" name="column-callback" placeholder="<?php _e( 'Callback Function Name', 'wpas-cf' ) ?>" value="<?php echo $column_callback ?>">
			<?php else : ?>
				<input type="text" name="column-callback" placeholder="<?php _e( 'Callback Function Name', 'wpas-cf' ) ?>">
			<?php endif; ?>
		</td>
	</tr>
